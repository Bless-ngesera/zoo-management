...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // Calculate total
        $adult_price = 200; // Would normally come from database
        $child_price = 100; // Would normally come from database
        $total = ($adults * $adult_price) + ($children * $child_price);
        
        // In a real app, this would save to database
        $ticket_id = 'IN-' . strtoupper(uniqid());
        $success = true;
    }
}
?>
...
<div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Indian Visitor Ticket</h1>
    ...
    <?php if (isset($success)): ?>
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
            ...
            <div class="mt-3">
                ...
                <a href="indian.php" class="bg-gray-200 text-gray-700 px-4 py-1 rounded hover:bg-gray-300 transition">
        ...
        <div class="border-t border-gray-200 pt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">₹200 per adult</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">₹100 per child</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            <div class="flex justify-between items-center">
                ...
                <div class="text-2xl font-bold" id="total-amount">
                    ₹<?php echo isset($total) ? $total : '200'; ?>
                </div>
            </div>
        </div>
